...
namespace Thetis
{
    class TitleBar
    {
        public const string BUILD_NAME = "MW0LGE pre-release/wd5y";
        public const string BUILD_DATE = "(2/16/22)<FW>"; //MW0LGE_21g <FW> gets replaced in BasicTitle (console.cs) with firmware version
